/**
 * Button styling, kept out of Button.tsx (a `"use client"` module) so Server
 * Components — the landing page's `<Link>` CTAs — can call `buttonClasses()`
 * too. Client code can keep importing it from `@/components/ui/Button`.
 */
